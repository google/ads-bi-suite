...
SELECT DISTINCT
  ...
  a.group_placement_view.placement_type AS Placement_type,
  a.group_placement_view.display_name AS Placement_name,
  a.group_placement_view.target_url AS Target_URL,
