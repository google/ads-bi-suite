...
SELECT DISTINCT
  ...
  a.disapproved_ads,
  a.underreview_ads,
  c.metrics.cost_micros / 1e6 AS Cost,
  ...
  c.metrics.search_rank_lost_impression_share AS Search_rank_lost_impression_share,
  c.metrics.content_budget_lost_impression_share AS Content_budget_lost_impression_share,
  c.metrics.content_rank_lost_impression_share AS Content_rank_lost_impression_share,
  conv.Add_to_cart,
  conv.Purchase,
  conv.Lead,
  conv.Signup,
