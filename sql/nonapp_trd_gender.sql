...
CREATE TEMP FUNCTION getGenderType(status INT64)
AS
(CASE status
...
select distinct
  ...
  getGenderType(a.adGroupCriterion.gender.type) as Gender,
...
from `${datasetId}.report_nonapp_campaign_perf_gender` a
