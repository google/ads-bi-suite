...
CREATE TEMP FUNCTION getDayOfWeek(status INT64)
  AS (['UNSPECIFIED','UNKNOWN','MONDAY','TUESDAY','WEDNESDAY','THURSDAY','FRIDAY','SATURDAY','SUNDAY'][OFFSET(status)]);
...
select distinct
  ...
  getDayOfWeek(a.segments.dayOfWeek) as Day_of_week,
